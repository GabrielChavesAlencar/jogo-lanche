...
public class ajuste_pos_ingrediente : MonoBehaviour
{
    ...
    public void ajustar() {
        ...
        else if (temp == "queijo")
        {
            ...
            else if (nome == "pao parte de cima") { transform.position = item_abaixo.transform.position + new Vector3(0, 0.25f, 0); }
        }
        else if (temp == "alface")
        {
        ...
        else if (temp == "tomate")
        {
            ...
            else if (nome == "queijo") { transform.position = item_abaixo.transform.position + new Vector3(0.06f, 0.13f, 0); }
